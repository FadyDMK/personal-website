...
const projects: ProjectProps[] = [
  {
    title: "HawkEye",
    description: "A 3D reconstruction app of a volleyball court using SfM techniques",
  ...
  },
  {
    ...
    description: "A full-stack movie logging application with user authentication",
    imageUrl: ProjectMovie,
    technologies: ["SvelteKit", "PostgreSQL", "Tailwind CSS", "Prisma", "Node.js"],
    githubUrl: "https://github.com/FadyDMK/movie-logger",
    liveUrl: "https://fanciful-genie-6dfa4d.netlify.app/",
  },
  {
    title: "Book Loaning App",
    description: "Book loaning application with user authentication and admin features",
